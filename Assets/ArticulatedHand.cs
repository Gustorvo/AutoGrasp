namespace SoftHand
{
    ...
    /// </summary>
    [Serializable]
    public class ArticulatedHand : IEquatable<ArticulatedHand>
    {
        /// <summary>
        ...
        /// </summary>
        public ArticulatedHand()
        {          
            Fingers = new List<ArticulatedFinger>(5);
            Fingers.Add(new ArticulatedFinger());
            Fingers.Add(new ArticulatedFinger());
            Fingers.Add(new ArticulatedFinger());
            Fingers.Add(new ArticulatedFinger());
            Fingers.Add(new ArticulatedFinger());
        ...
        /// </summary>
        public ArticulatedHand(long frameID, int id, float confidence, float grabStrength, float grabAngle, float pinchStrength, float pinchDistance,
            float palmWidth, bool isLeft, float timeVisible, List<ArticulatedFinger> fingers, Vector3 palmPosition,
            Vector3 stabilizedPalmPosition, Vector3 palmVelocity, Vector3 palmNormal, Quaternion palmOrientation, Vector3 direction, Vector3 wristPosition)
        {
            FrameId = frameID;
            Id = id;
        ...
        /// </summary>
        public ArticulatedFinger Finger(int id)
        {
        ...
        /// </summary>
        public bool Equals(ArticulatedHand other)
        {
        ...
        /// </summary>
        public List<ArticulatedFinger> Fingers;
