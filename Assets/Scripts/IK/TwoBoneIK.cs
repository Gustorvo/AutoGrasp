...
namespace SoftHand.Experimental
{
    public class TwoBoneIK : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            UnityEngine.Debug.Log($"angle: {angle}, axis: {axis}, multiplied: {angle * axis}");
        ...
        public void Solve()
        {
            ...
            // Debug.Log("The angle is: " + CosAngle(a, b, c));
            UnityEngine.Debug.DrawLine(UpperDummy.position, Target.position);
            UnityEngine.Debug.DrawLine((UpperDummy.position + Target.position) / 2, MiddleDummy.position);
            UnityEngine.Debug.DrawLine(middle, middle + dir * (distanceToMiddle + 0.25f), Color.red);
            UnityEngine.Debug.DrawLine(MiddleDummy.position, MiddleDummy.position + -MiddleDummy.up * 0.25f, Color.green);
            UnityEngine.Debug.DrawLine(EndDummy.position, EndDummy.position + EndDummy.right * 0.25f, Color.black);
            UnityEngine.Debug.DrawLine(EndDummy.position, EndDummy.position + EndDummy.forward * 0.25f, Color.black);
            UnityEngine.Debug.DrawLine(EndDummy.position, EndDummy.position + EndDummy.up * 0.25f, Color.black);
