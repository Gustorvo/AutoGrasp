...
namespace SoftHand
{
    public class DrawCapsule : MonoBehaviour
    {
        ...
        private Matrix4x4[] sphereMatrices = new Matrix4x4[1];
        ...
        void Update()
        {
            ...
            sphereMatrices[0] = Matrix4x4.TRS(midPoint, Quaternion.identity, Vector3.one * scale);
            Graphics.DrawMeshInstanced(capsuleMesh, 0, CapsuleMaterial, sphereMatrices, 1, null,
                 true ? UnityEngine.Rendering.ShadowCastingMode.On : UnityEngine.Rendering.ShadowCastingMode.Off, true, gameObject.layer);
