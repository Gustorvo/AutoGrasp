...
namespace SoftHand
{
    // source: https://github.com/zalo/MathUtilities/blob/81c65742953b3558b9aee5bc68fe6a5e6ce7e6fa/Assets/Constraints/Constraints.cs
    ...
    public static class Constraints
    {
        ...
        {
            Vector3 onSegment = position.ConstrainToSegment(a, b);
        ...
        public static Vector3 ClosestPointOnCapsule(this Vector3 point, CapsuleCollider collider)
        {
            ...
            Vector3 onSegment = point.ConstrainToSegment(collider.transform.TransformPoint(collider.center + offset), collider.transform.TransformPoint(collider.center - offset));
        ...
        {
            return Quaternion.FromToRotation(rotation * objectLocalAxis, (rotation * objectLocalAxis).ConstrainToNormal(constraintAxis, maxAngle)) * rotation;
        }
