...
namespace SoftHand
{
    ...
    public class ArticulatedHandsController : MonoBehaviour, IArticulatedHandsController
    {
        ...
        [SerializeField] bool _moveHands, _rotateHands, _stabilizeHands, _moveFingers, _allowTeleport;
        ...
        private void FixedUpdate()
        {
            ...
            if (_stabilizeHands) StabilizeHands();
        ...
        public void MoveHands()
        {
            for (int i = 0; i < _handMovers.Count; i++)
            {
                ...
                if (!teleport &&_moveHands) _handMovers[i].MoveBody();
                if (!teleport && _rotateHands) _handMovers[i].RotateBody();
            }
        }
